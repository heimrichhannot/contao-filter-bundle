...
class PasswordTypeTest extends ContaoTestCase
{
    /**
    ...
    public function testCanBeInstantiated()
    {
        ...
        $type = new PasswordType($config);

        $this->assertInstanceOf('HeimrichHannot\FilterBundle\Filter\Type\PasswordType', $type);
    }
    ...
    public function testBuildFormWithFieldName()
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\Form\Extension\Core\Type\PasswordType::class, $config->getBuilder()->get('test')->getType()->getInnerType());
    }
