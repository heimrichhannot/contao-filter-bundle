...
class MoneyTypeTest extends ContaoTestCase
{
    /**
    ...
    public function testCanBeInstantiated()
    {
        ...
        $type = new MoneyType($config);

        $this->assertInstanceOf('HeimrichHannot\FilterBundle\Filter\Type\MoneyType', $type);
    }
    ...
    public function testBuildFormWithFieldName()
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\Form\Extension\Core\Type\MoneyType::class, $config->getBuilder()->get('test')->getType()->getInnerType());
    }
