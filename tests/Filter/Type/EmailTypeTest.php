...
class EmailTypeTest extends ContaoTestCase
{
    /**
    ...
    public function testCanBeInstantiated()
    {
        ...
        $type = new EmailType($config);

        $this->assertInstanceOf('HeimrichHannot\FilterBundle\Filter\Type\EmailType', $type);
    }
    ...
    public function testBuildFormWithFieldName()
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\Form\Extension\Core\Type\EmailType::class, $config->getBuilder()->get('test')->getType()->getInnerType());
    }
