...
class ColorTypeTest extends ContaoTestCase
{
    /**
    ...
    public function testCanBeInstantiated()
    {
        ...
        $type = new ColorType($config);

        $this->assertInstanceOf('HeimrichHannot\FilterBundle\Filter\Type\ColorType', $type);
    }
    ...
    public function testBuildFormWithFieldName()
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\Form\Extension\Core\Type\ColorType::class, $config->getBuilder()->get('test')->getType()->getInnerType());
    }
