...
class LocaleTypeTest extends ContaoTestCase
{
    /**
    ...
    public function testCanBeInstantiated()
    {
        ...
        $this->assertInstanceOf('HeimrichHannot\FilterBundle\Filter\Type\LocaleType', $type);
    }
    ...
    public function testBuildFormWithFieldName()
    {
        ...
        $this->container->set('huh.filter.choice.type', new TypeChoice($framework));
        $this->container->set('huh.filter.choice.locale', new LocaleChoice($framework));
        System::setContainer($this->container);
        ...
        $element->type = 'locale';
        $element->field = 'test';
        $element->customLocales = true;
        $element->locales = ['de', 'en'];
