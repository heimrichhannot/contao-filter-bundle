...
class RangeTypeTest extends ContaoTestCase
{
    ...
    public function testBuildFormWithFieldName()
    {
        ...
        $this->assertEquals(20, $config->getBuilder()->get('test')->getForm()->getConfig()->getOption('attr')['min']);
        $this->assertEquals(80, $config->getBuilder()->get('test')->getForm()->getConfig()->getOption('attr')['max']);
        $this->assertEquals(10, $config->getBuilder()->get('test')->getForm()->getConfig()->getOption('attr')['step']);
    }
