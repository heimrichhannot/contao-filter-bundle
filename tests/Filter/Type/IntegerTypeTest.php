...
class IntegerTypeTest extends ContaoTestCase
{
    /**
    ...
    public function testCanBeInstantiated()
    {
        ...
        $type = new IntegerType($config);

        $this->assertInstanceOf('HeimrichHannot\FilterBundle\Filter\Type\IntegerType', $type);
    }
    ...
    public function testBuildFormWithFieldName()
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\Form\Extension\Core\Type\IntegerType::class, $config->getBuilder()->get('test')->getType()->getInnerType());
    }
