...
class PercentTypeTest extends ContaoTestCase
{
    /**
    ...
    public function testCanBeInstantiated()
    {
        ...
        $type = new PercentType($config);

        $this->assertInstanceOf('HeimrichHannot\FilterBundle\Filter\Type\PercentType', $type);
    }
    ...
    public function testBuildFormWithFieldName()
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\Form\Extension\Core\Type\PercentType::class, $config->getBuilder()->get('test')->getType()->getInnerType());
    }
