...
class TextareaTypeTest extends ContaoTestCase
{
    /**
    ...
    public function testCanBeInstantiated()
    {
        ...
        $type = new TextareaType($config);

        $this->assertInstanceOf('HeimrichHannot\FilterBundle\Filter\Type\TextareaType', $type);
    }
    ...
    public function testBuildFormWithFieldName()
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\Form\Extension\Core\Type\TextareaType::class, $config->getBuilder()->get('test')->getType()->getInnerType());
    }
