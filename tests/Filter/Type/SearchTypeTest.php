...
class SearchTypeTest extends ContaoTestCase
{
    /**
    ...
    public function testCanBeInstantiated()
    {
        ...
        $type = new SearchType($config);

        $this->assertInstanceOf('HeimrichHannot\FilterBundle\Filter\Type\SearchType', $type);
    }
    ...
    public function testBuildFormWithFieldName()
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\Form\Extension\Core\Type\SearchType::class, $config->getBuilder()->get('test')->getType()->getInnerType());
    }
