...
$lang['addDefaultValue']    = ['Standardwert hinzufügen', 'HINWEIS: Dieser Wert wird NICHT initial ausgewertet, sondern gibt nur einen Standardwert für das Filterfeld vor. Wenn Sie einen initialen *Filter* festlegen wollen, erstellen Sie ein Filterelement vom Typ "Initial".'];
