...
$lang['threshold'] = ['Threshold', 'Enter minimum count of entered chars before submit.'];
$lang['optionCountLabel'] = ['Debounce', 'Enter idle time in ms to wait after input before form gets submitted.'];
