...
$lang['addDefaultValue']    = ['Add default value', 'HINT: The value is not processed initially, but is only set as a default value for the filter field. If you want to specify an initial *filter*, please add a new filter element of type "initial".'];
