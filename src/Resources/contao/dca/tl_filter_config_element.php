...
$GLOBALS['TL_DCA']['tl_filter_config_element'] = [
    ...
    'palettes'    => [
        '__selector__' => ['type', 'customOptions', 'customName', 'addPlaceholder', 'customLabel', 'dateTimeFormat', 'customCountries', 'customLanguages', 'customLocales', 'customValue', 'published'],
