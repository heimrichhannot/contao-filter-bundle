...
$GLOBALS['TL_DCA']['tl_filter_config_element'] = [
    ...
    'palettes'    => [
        ...
        'date'         => '{general_legend},title,type;{config_legend},field,name,customValue,customLabel,dateFormat,minDate,maxDate;{expert_legend},cssClass;{publish_legend},published;',
        'date_range'   => '{general_legend},title,type;{config_legend},startElement,stopElement,name,customLabel;{expert_legend},cssClass;{publish_legend},published;',
    ],
    'subpalettes' => [
