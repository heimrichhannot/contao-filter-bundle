...
$GLOBALS['TL_DCA']['tl_filter_config_element'] = [
    ...
    'palettes'    => [
        ...
        \HeimrichHannot\FilterBundle\Filter\Type\ProximitySearchType::TYPE
                       => '{general_legend},title,type;{config_legend},name,proximitySearchExplanation,radiusElement,coordinatesMode,allowHtmlGeoLocation,cityElement,postalElement,stateElement,countryElement;{expert_legend},cssClass;{publish_legend},published;',
        ...
        \HeimrichHannot\FilterBundle\Filter\Type\DateRangeType::TYPE
                       => '{general_legend},title,type;{config_legend},startElement,stopElement,name;{visualization_legend},customLabel,hideLabel;{expert_legend},cssClass;{publish_legend},published;',
        ...
        \HeimrichHannot\FilterBundle\Filter\Type\RadiusChoiceType::TYPE
                       => '{general_legend},title,type;{config_legend},addDefaultValue;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup{expert_legend},cssClass;{publish_legend},published;',
    ...
    'subpalettes' => [
        ...
        'coordinatesMode_' . \HeimrichHannot\FilterBundle\Filter\Type\ProximitySearchType::COORDINATES_MODE_COMPOUND
                               => 'coordinatesField',
        'coordinatesMode_' . \HeimrichHannot\FilterBundle\Filter\Type\ProximitySearchType::COORDINATES_MODE_SEPARATED
                               => 'latField,longField',
