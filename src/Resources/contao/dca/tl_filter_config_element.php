...
$GLOBALS['TL_DCA']['tl_filter_config_element'] = [
    ...
    'palettes'    => [
        ...
        'text'         => '{general_legend},title,type;{config_legend},field,customName;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        ...
        'textarea'     => '{general_legend},title,type;{config_legend},field,customName;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'email'        => '{general_legend},title,type;{config_legend},field,customName;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'integer'      => '{general_legend},title,type;{config_legend},field,customName,grouping,scale,rounding_mode;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'money'        => '{general_legend},title,type;{config_legend},field,customName,currency,divisor,grouping,scale;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'number'       => '{general_legend},title,type;{config_legend},field,customName,grouping,scale,roundingMode;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'password'     => '{general_legend},title,type;{config_legend},field,customName,alwaysEmpty;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'search'       => '{general_legend},title,type;{config_legend},field,customName;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'percent'      => '{general_legend},title,type;{config_legend},field,customName,scale,percentType;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'url'          => '{general_legend},title,type;{config_legend},field,customName,defaultProtocol;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'range'        => '{general_legend},title,type;{config_legend},field,customName,min,max,step;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'tel'          => '{general_legend},title,type;{config_legend},field,customName;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'color'        => '{general_legend},title,type;{config_legend},field,customName;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'choice'       => '{general_legend},title,type;{config_legend},field,customOptions,customName,expanded,multiple;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'country'      => '{general_legend},title,type;{config_legend},field,customCountries,customOptions,customName,expanded,multiple;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'language'     => '{general_legend},title,type;{config_legend},field,customLanguages,customOptions,customName,expanded,multiple;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        'locale'       => '{general_legend},title,type;{config_legend},field,customLocales,customOptions,customName,expanded,multiple;{visualization_legend},addPlaceholder,customLabel,hideLabel,inputGroup;{expert_legend},cssClass;{publish_legend},published;',
        ...
        'checkbox'     => '{general_legend},title,type;{config_legend},field,customName,customValue;{visualization_legend},customLabel,hideLabel;{expert_legend},cssClass;{publish_legend},published;',
        'radio'        => '{general_legend},title,type;{config_legend},field,customName,customValue;{visualization_legend},customLabel,hideLabel;{expert_legend},cssClass;{publish_legend},published;',
