...
class FilterConfigElementContainer
{
    ...
    public function onLoadCallback(DataContainer $dc = null): void
    {
        ...
        if ($class && !$class::isEnabledForCurrentContext([
            ...
            Message::addError($this->translator->trans('huh.filter.warning.not_supported_in_current_content'));
        }
    }
    ...
    public function onListSortingChildRecordCallback(array $row): string
    {
        ...
        return '<div class="tl_content_left">'
            .($enabled ? '' : Image::getHtml('error.svg', $this->translator->trans('huh.filter.warning.not_supported_in_current_content'), 'style="padding-right: 3px;" title="'.$this->translator->trans('huh.filter.warning.not_supported_in_current_content').'"'))
