...
class LanguageType extends AbstractType implements TypeInterface
{
    /**
     * @inheritDoc
     */
    ...
    protected function getOptions(array $element, FormBuilderInterface $builder)
    {
        ...
        $options['choices']                   = System::getContainer()->get('huh.filter.choice.language')->getCachedChoices([$element, $this->config->getFilter()]);
