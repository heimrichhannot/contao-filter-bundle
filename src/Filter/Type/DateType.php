...
//		{return;}
    ...
    {
        $builder->add(
            $builder->create($this->getName($element, $element['name']), FormType::class, ['inherit_data' => true])
                ->add(static::START_SUFFIX, \Symfony\Component\Form\Extension\Core\Type\DateTimeType::class, $this->getOptions($element, $builder))
                ->add(static::STOP_SUFFIX, \Symfony\Component\Form\Extension\Core\Type\DateTimeType::class, $this->getOptions($element, $builder))
        );
    }
