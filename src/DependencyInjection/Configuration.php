...
//                                ->scalarNode('repeated')->cannotBeEmpty()->defaultValue(RepeatedType::class)->end()
                        ...
                        ->arrayNode('templates')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('form_div_layout')->cannotBeEmpty()->defaultValue('@HeimrichHannotContaoFilter/filter/filter_form_div_layout.html.twig')->end()
                                ->scalarNode('form_table_layout')->cannotBeEmpty()->defaultValue('@HeimrichHannotContaoFilter/filter/filter_form_table_layout.html.twig')->end()
                                ->scalarNode('bootstrap_3_layout')->cannotBeEmpty()->defaultValue('@HeimrichHannotContaoFilter/filter/filter_form_bootstrap_3_layout.html.twig')->end()
                                ->scalarNode('bootstrap_3_horizontal_layout')->cannotBeEmpty()->defaultValue('@HeimrichHannotContaoFilter/filter/filter_form_bootstrap_3_horizontal_layout.html.twig')->end()
                                ->scalarNode('bootstrap_4_layout')->cannotBeEmpty()->defaultValue('@HeimrichHannotContaoFilter/filter/filter_form_bootstrap_4_layout.html.twig')->end()
                                ->scalarNode('bootstrap_4_horizontal_layout')->cannotBeEmpty()->defaultValue('@HeimrichHannotContaoFilter/filter/filter_form_bootstrap_4_horizontal_layout.html.twig')->end()
                                ->scalarNode('foundation_5_layout')->cannotBeEmpty()->defaultValue('@HeimrichHannotContaoFilter/filter/filter_form_foundation_5_layout.html.twig')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
